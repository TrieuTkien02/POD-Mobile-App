...
class _CartItemCheckoutState extends State<CartItemCheckout> {
  ...
  Widget build(BuildContext context) {
    ...
    final formattedPrice = priceFormat
        .format(appProvider.totalPriceBuyProductList().toInt())
        .replaceAll(',', '.');
    return Scaffold(
      appBar: AppBar(
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemCount: appProvider.getBuyProductList.length,
                itemBuilder: (context, index) {
                  ProductModel product = appProvider.getBuyProductList[index];
                  return Container(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${priceFormat.format(appProvider.price1Product(product)).replaceAll(',', '.')} VNĐ",
                                            style: const TextStyle(
                                              fontSize: 15.0,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.red,
